...
public interface ExampleConnector : com.google.firebase.dataconnect.generated.GeneratedConnector<ExampleConnector> {
  override val dataConnect: com.google.firebase.dataconnect.FirebaseDataConnect
    ...
    public val createSubject: CreateSubjectMutation
  
    public val getGoalsForUser: GetGoalsForUserQuery
  
    public val getTasksForSubject: GetTasksForSubjectQuery
  
    public val updateTaskCompletion: UpdateTaskCompletionMutation
...
private class ExampleConnectorImpl(
  override val dataConnect: com.google.firebase.dataconnect.FirebaseDataConnect
    ...
    override val createSubject by lazy(LazyThreadSafetyMode.PUBLICATION) {
      CreateSubjectMutationImpl(this)
    }
  
    override val getGoalsForUser by lazy(LazyThreadSafetyMode.PUBLICATION) {
      GetGoalsForUserQueryImpl(this)
    }
  
    override val getTasksForSubject by lazy(LazyThreadSafetyMode.PUBLICATION) {
      GetTasksForSubjectQueryImpl(this)
    }
  
    override val updateTaskCompletion by lazy(LazyThreadSafetyMode.PUBLICATION) {
      UpdateTaskCompletionMutationImpl(this)
    }
...
private class CreateSubjectMutationImpl(
  connector: ExampleConnector
):
  ...
  >(
    connector,
    CreateSubjectMutation.Companion.operationName,
    CreateSubjectMutation.Companion.dataDeserializer,
    CreateSubjectMutation.Companion.variablesSerializer,
  )


private class GetGoalsForUserQueryImpl(
  connector: ExampleConnector
):
  GetGoalsForUserQuery,
  ExampleConnectorGeneratedQueryImpl<
      GetGoalsForUserQuery.Data,
      GetGoalsForUserQuery.Variables
  >(
    connector,
    GetGoalsForUserQuery.Companion.operationName,
    GetGoalsForUserQuery.Companion.dataDeserializer,
    GetGoalsForUserQuery.Companion.variablesSerializer,
  )


private class GetTasksForSubjectQueryImpl(
  connector: ExampleConnector
):
  GetTasksForSubjectQuery,
  ExampleConnectorGeneratedQueryImpl<
      GetTasksForSubjectQuery.Data,
      GetTasksForSubjectQuery.Variables
  >(
    connector,
    GetTasksForSubjectQuery.Companion.operationName,
    GetTasksForSubjectQuery.Companion.dataDeserializer,
    GetTasksForSubjectQuery.Companion.variablesSerializer,
  )


private class UpdateTaskCompletionMutationImpl(
  connector: ExampleConnector
):
  ...
  >(
    connector,
    UpdateTaskCompletionMutation.Companion.operationName,
    UpdateTaskCompletionMutation.Companion.dataDeserializer,
    UpdateTaskCompletionMutation.Companion.variablesSerializer,
  )
